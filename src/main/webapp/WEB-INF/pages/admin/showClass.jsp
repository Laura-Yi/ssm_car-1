                        ...
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                <table class="table">
                                    ...
                                    <tbody>
                                    <c:forEach items="${classroomList}" var="classroom" varStatus="item">
                                        <tr>
                                            <td>${item.count}</td>
                                            <td>${classroom.name}</td>
                                            <td>${classroom.building}</td>
                                            <td><a href="${basePath}/adminSchedule/showTimetable?classroomId=${classroom.id}">查看课程表</a></td>
                                        </tr>
                                    </c:forEach>
                                    </tbody>
                                </table>
