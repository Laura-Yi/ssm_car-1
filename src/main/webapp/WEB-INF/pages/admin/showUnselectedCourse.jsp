                            ...
                            <div class="panel-body">
                                <table class="table">
                                    ...
                                    <c:forEach items="${educationplanList}" var="education">
                                        <tr>
                                            <form action="${basePath}/adminSchedule/addSchedulecourse?educationplanId=${education.id}" method="post">
                                            <td>
                                                <c:if test="${empty education.request}">
                                                <input type="checkbox" value="${education.id}" name="educationplan">
                                                </c:if>
                                            </td>
                                            <td>${education.content}</td>
                                            <td>
                                                <c:forEach items="${teacherList}" var="teacher">
                                                    <c:if test="${teacher.id == education.teacher}">
                                                        ${teacher.name}
                                                    </c:if>
                                                </c:forEach>
                                            </td>
                                            ...
                                            <td>
                                                <select name="daytime">
                                                    <option value="1" selected="selected">第一节课</option>
                                                    <option value="2" selected="selected">第二节课</option>
                                                    <option value="3" selected="selected">第三节课</option>
                                                    <option value="4" selected="selected">第四节课</option>
                                                    <option value="5" selected="selected">第五节课</option>
                                                </select>
                                            </td>
