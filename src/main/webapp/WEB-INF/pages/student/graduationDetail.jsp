...
<div id="wrapper">
    ...
    <div class="main">
        ...
        <div class="main-content">
            <div class="container-fluid">
                <h3 class="page-title">论文详情</h3>
                <div class="row">
                    <div class="col-md-6">
                        <!-- BASIC TABLE -->
                        <div class="panel">
                            <c:choose>
                                <c:when test="${graduationmanager eq null}">
                                    <div class="panel-heading">
                                        <h3 class="panel-title">还没有选择论文</h3>
                                    </div>
                                </c:when>
                                <c:otherwise>
                                    <div class="panel-body">
                                        <table class="table">
                                            ...
                                            <tr>
                                                ...
                                                <form action="${basePath}/studentGraduate/uploadfile/选题报告?graduationId=${graduationmanager.id}" method="post" enctype="multipart/form-data">
                                            ...
                                            <tr>
                                                ...
                                                <form action="${basePath}/studentGraduate/uploadfile/中期考核表?graduationId=${graduationmanager.id}" method="post" enctype="multipart/form-data">
                                                    <td><input type="file" name="file"/></td>
                                                    <td><input type="submit" value="上传"/></td>
                                                </form>
                                            </tr>
                                            <tr>
                                                ...
                                                <form action="${basePath}/studentGraduate/uploadfile/毕业论文?graduationId=${graduationmanager.id}" method="post" enctype="multipart/form-data">
                                                    <td><input type="file" name="file"/></td>
                                                    <td><input type="submit" value="上传"/></td>
                                                </form>
                                            </tr>
