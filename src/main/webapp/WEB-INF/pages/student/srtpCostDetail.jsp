                            ...
                            <div class="panel-body">
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <form action="${basePath}/studentSrtp/addCost?srtpId=${srtpmanager.id}" method="post" >
...
$("input[name='delSrtpCost']").click(function () {
    ...
    window.location.href="${basePath}/studentSrtp/delSrtpCost?srtpId=${srtpmanager.id}&srtpCostId="+srtpCostId;
})
</script>
</body>
</html>