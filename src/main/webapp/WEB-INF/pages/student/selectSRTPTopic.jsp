            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="panel">
                            <c:choose>
                            <c:when test="${srtpmanager eq 'selected'}">
                                <div class="panel-heading">
                                    <h3 class="panel-title">你已经选择了SRTP</h3>
                                </div>
                            </c:when>
                            <c:otherwise>
                                <div class="panel-heading">
                                    ...
                                    <table class="table">
                                        ...
                                        <c:forEach items="${srtpmanagerList}" var="srtp">
                                            <tr>
                                                <td>${srtp.id}</td>
                                                <td>${srtp.srtpname}</td>
                                                <td><input type="button" name="select" id="${srtp.id}" value="选择" ></td>
                                            </tr>
                                        </c:forEach>
                                        </tbody>
                                    </table>
...
<script type="text/javascript">
    $("input[name='select']").click(function () {
        var srtpId = this.id;
        confirm("确认选择当前SRTP课题吗？");
        window.location.href="${basePath}/studentSrtp/doSelect?srtpId="+srtpId;
    })
